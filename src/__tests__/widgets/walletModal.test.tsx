...
it("renders ConnectModal correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <div
        class="sc-iCfMLu esWkxM"
      >
        <div
          class="sc-furwcr iWIivq"
        >
          <div
            class="sc-eCImPb sc-pVTFL jpuLQT jNeVHa"
          >
            <h2
              class="sc-bdvvtL sc-hKwDye hBYGJn gogdWC"
              color="text"
            >
              Connect to a wallet
            </h2>
          ...
          <button
            ...
            class="sc-jRQBWg cRATkB sc-gKclnd bGsNxc"
            type="button"
          >
            <svg
              class="sc-dkPtRN kqPzQJ"
              color="primary"
              viewBox="0 0 24 24"
              width="20px"
        ...
        >
          <button
            class="sc-jRQBWg ecxUDz"
            id="wallet-connect-metamask"
            style="justify-content: space-between;"
            type="button"
          >
            <div
              class="sc-bdvvtL ddWegn"
              color="primary"
            >
              Metamask
            </div>
            <svg
              class="sc-dkPtRN eAvxUI"
              color="text"
              viewBox="0 0 96 96"
              width="32px"
              xmlns="http://www.w3.org/2000/svg"
    ...
    <DocumentFragment>
      ...
      >
        ...
        >
          ...
          <div
            class="sc-eCImPb hgyeJv"
          >
            <a
              class="sc-bdvvtL sc-gsDKAQ kaPGiN kuhloL"
              color="primary"
            ...
            <div
              class="sc-bdvvtL sc-crHmcD jlZdXh bkPOpv"
              color="text"
              role="button"
            >
              Copy Address
